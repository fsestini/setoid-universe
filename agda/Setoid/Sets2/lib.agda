...
in-U~ₜ a₀ a₁ bool~ₚ = ↑pl ⊤p
in-U~ₜ a₀ a₁ (π~ₚ {A₀} a₀ₚ {A₀~} a₀~ₚ {A₁} a₁ₚ {A₁~} a₁~ₚ {A₀₁} a₀₁ₚ {B₀} b₀ₚ {B₀~} b₀~ₚ {B₁} b₁ₚ {B₁~} b₁~ₚ {B₀₁} b₀₁ₚ) =
  in-Uₜ a₀ₚ ×p
...
π~ {A₀}{a₀ₚ ,sp a₀}{A₀~}{a₀~ₚ ,sp a₀~}{A₁}{a₁ₚ ,sp a₁}{A₁~}{a₁~ₚ ,sp a₁~}{A₀₁}(a₀₁ₚ ,sp a₀₁){B₀}{b₀}{B₀~}{b₀~}{B₁}{b₁}{B₁~}{b₁~}{B₀₁} b₀₁ =
  ...
  (a₀ ,p a₀~ ,p a₁ ,p a₁~ ,p a₀₁ ,p (λ x → proj₂sp (b₀ x)) ,p (λ x₀₁ → proj₂sp (b₀~ x₀₁)) ,p (λ x → proj₂sp (b₁ x)) ,p (λ x₀₁ → proj₂sp (b₁~ x₀₁)) ,p λ x₀₁ → proj₂sp (b₀₁ x₀₁))
...
module _
  ...
  ind-in-U~ {a₀ = a₀ₚ ,sp a₀}{a₁ = a₁ₚ ,sp a₁} (bool~ₚ ,sp _) = {!bool~ᴰ!} -- bool~ᴰ
  ind-in-U~ (π~ₚ a₀ₚ a₀~ₚ a₁ₚ a₁~ₚ a₀₁ₚ b₀ₚ b₀~ₚ b₁ₚ b₁~ₚ b₀₁ₚ ,sp (a₀ ,p a₀~ ,p a₁ ,p a₁~ ,p a₀₁ ,p b₀ ,p b₀~ ,p b₁ ,p b₁~ ,p b₀₁)) =
    {!!}
{-
