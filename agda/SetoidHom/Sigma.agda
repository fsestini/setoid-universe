...
module _ {i}{Γ : Con i}{j}(A : Ty Γ j){k}(B : Ty (Γ ▷ A) k) where
  ...
  ∣ mkΣ' u v ∣t γ = ∣ u ∣t γ ,Σ ∣ v ∣t γ
  ~t (mkΣ' u v) γ~ = ~t u γ~ ,p transC (EL B _) (symC (EL B _) (subst-trans B _ _ _)) (~t v γ~)
  ...
  ∣ pr₂' t ∣t γ = proj₂ (∣ t ∣t γ)
  ~t (pr₂' t) γ~ = transC (EL B _) (subst-trans B _ _ _) (proj₂p (~t t γ~))
