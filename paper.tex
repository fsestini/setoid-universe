...
\begin{align*}
  ...
  (b : (x : A) \to \inU\;(B\;x))\\
  & \qquad\ \to \inU\;a\;a\;A_\sim \to (\forall\{x_0\;x_1\}(x_{01} : A_\sim\;x_0\;x_1)
  ...
  & \qquad \pi_\sim :
  \forall\{A_0\;A_1\;A_{0\sim}\;A_{01\sim}\;B_0\;B_1\;B_{0\sim}\;B_{1\sim}\;B_{01\sim}\}
...
of $\El$, in the same way $\inUU\ p\ q$ classifies all relations of type $A \to
A' \to \mProp$ that are image of $\_\vdash\_\sim_{\El}\_$, given proofs $p :
\inU\ A, q : \inU\ A'$.
%
