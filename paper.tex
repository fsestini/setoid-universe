...
\author{Thorsten Altenkirch\inst{1}
  ...
  \orcidID{0000-0002-6582-5025}\Letter \and
...
\institute{School of Computer Science, University of Nottingham, Nottingham, UK
...
\authorrunning{T. Altenkirch, S. Boulier, A. Kaposi, C. Sattler and F. Sestini}
...
%% %
%% \begin{align*}
%%   & (\Pi(a : A)\ B)^\sim\ p\ f_0\ f_1 = \Pi(a_0\,a_1 : A)\ldots \\
%%   & (\Sigma\ A\ B)^\sim\ p\ (a_0, b_0)\ (a_1, b_1) = \ldots \\
%%   & \Prop^\sim\ p\ P\ Q = \ldots
%% \end{align*}
