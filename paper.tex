...
The inductive definition of the universe relies on a metatheory with a strong
transport rule. As future work, we would like to prove normalization for this
metatheory, since we don't yet know if this property holds in the presence of
such rule, and previous work in this respect \cite{abel2019failure} seems to
