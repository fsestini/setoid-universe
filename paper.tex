...
\infer{
  \begin{aligned}
    ...
    (p : \GG^\sim\ \gamma_0\ \gamma_1) \to A^\sim\ p\ (|t|\gamma_0)\ (|t|\gamma_1)
  \end{aligned}
}{
  t : \Tm\ \GG\ A
}
...
We are now ready to give a full definition of the setoid universe:
%
\begin{align*}
...
We can show that $\Uty$ is closed under $\Pi$ types and unit types, including
...
Previous work \cite{abel2019failure} seems to suggest that the strong transport
