...
to internalize the notion of type beyond propositions. This paper is a step
towards extending SeTT with a universe of setoids.
%
...
small metatheory, that however must include a proof-irrelevant identity type
with a strong transport rule. \keywords{type theory \and
...
A' \to \mProp$ that are image of $\_\vdash\_\sim_{\El}\_$,
given proofs $p : \inU\ A, q : \inU\ A'$.
%
